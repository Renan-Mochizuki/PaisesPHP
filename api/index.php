...
<div id="fundo"><diV>
    ...
    <form method="post">
        ...
        <div id="container">
            ...
            <div id="dados">
                <div class="sub">
                    <p class="atributo">Nome Oficial:&nbsp</p>
                    <p class="valor">
                        <?php echo @$json[0] -> translations -> por -> official; ?>
                    </p>
                </div>
                <div class="sub">
                    <p class="atributo">Nome Comum:&nbsp</p>
                    <p class="valor">
                        <?php echo @$json[0] -> translations -> por -> common; ?>
                    </p>
                </div>
                <div class="sub">
                    <p class="atributo">Capital:&nbsp</p>
                    <p class="valor"> 
                    <?php 
                ...
                <div class="sub">
                    <p class="atributo">População:&nbsp</p>
                    <p class="valor"> 
                    <?php
                ...
                <div class="sub">
                    <p class="atributo">Estado de dependência:&nbsp</p>
                    <p class="valor"> 
                    <?php 
                ...
                <div class="sub">
                    <p class="atributo">Região:&nbsp</p>
                    <p class="valor"> 
                    <?php 
                ...
                <div id="mapabotao">
                    <a target="_blank" href="<?php echo @$json[0] -> maps -> openStreetMaps; ?>">
                    <div>Ver no Mapa</div>
                </a>
                </div>
            </div>
